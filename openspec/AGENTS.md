...
- Scaffold: `proposal.md`, `implementation.md`, `tasks.md`, `design.md` (only if needed), and delta specs per affected capability
...
2. Choose a unique verb-led `change-id` and scaffold `proposal.md`, `implementation.md`, `tasks.md`, optional `design.md`, and spec deltas under `openspec/changes/<id>/`.
...
3. **Read implementation.md** - Get implementation details
...
│   │   ├── implementation.md # Implementation detail
